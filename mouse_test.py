...
print(g.filter_message_to_host(b'\x00\x00\xff\xff\xf3\xff\x00\x00')
      == b'\xa1\x03\x00\x00\xff\xff\xf3\xff\x00')
...
print(mx.filter_message_to_host(b'\x00\x17\x0c\x00\x17\xc0\x00')
      == b'\xa1\x03\x00\x00\x17\x00\x0c\x00\x00')


#  Button: 0  0  0  0  0  0  0  0 | # | 0xff000040:   15 ,  -42 | Wheel:    0 | X:    15 | Y:   -42
# 00 0f d6 00 0f 60 fd
print(mx.filter_message_to_host(b'\x00\x0f\xd6\x00\x0f\x60\xfd')
      == b'\xa1\x03\x00\x00\x0f\x00\xd6\xff\x00')


#  Button: 0  0  0  0  0  0  0  0 | # | 0xff000040:   -7 ,   18 | Wheel:    0 | X:    -7 | Y:    18
# 00 f9 12 00 f9 2f 01
print(mx.filter_message_to_host(b'\x00\xf9\x12\x00\xf9\x2f\x01')
      == b'\xa1\x03\x00\x00\xf9\xff\x12\x00\x00')

#  Button: 1  1  0  0  0  0  0  0 | # | 0xff000040:    0 ,    0 | Wheel:    0 | X:     0 | Y:     0
# 03 00 00 00 00 00 00
print(mx.filter_message_to_host(b'\x03\x00\x00\x00\x00\x00\x00')
      == b'\xa1\x03\x03\x00\x00\x00\x00\x00\x00')

#  Button: 0  0  0  0  0  0  0  0 | # | 0xff000040:    0 ,    0 | Wheel:   -1 | X:     0 | Y:     0
# 00 00 00 ff 00 00 00
print(mx.filter_message_to_host(b'\x00\x00\x00\xff\x00\x00\x00')
      == b'\xa1\x03\x00\x00\x00\x00\x00\x00\xff')
